...
//Lifter Heights
const int LIFTERBOTTOM_PRACTICE = 50;
const int LIFTERTOP_PRACTICE = 3550;
const int GRABHEIGHTFLOOR_PRACTICE = 125;
const int GRABHEIGHTSCORINGPLATFORM_PRACTICE = 220;
const int GRABHEIGHTCONVEYORPLATFORM_PRACTICE = 800;
...
const int HOLDHEIGHT_PRACTICE = 3475;
const int HEIGHTTOLERANCE_PRACTICE = 250; //Test this value
