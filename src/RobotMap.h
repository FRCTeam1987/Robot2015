...
const int GRABHEIGHTSCORINGPLATFORM_PRACTICE = 260;
const int GRABHEIGHTCONVEYORPLATFORM_PRACTICE = 716;
...
const int GRABHEIGHTCONVEYORPLATFORM_COMPETITION = 300; //Need to find value
