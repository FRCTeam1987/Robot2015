...
const int GRABHEIGHTPLATFORM_PRACTICE = 950;
const int COOPHEIGHT_PRACTICE = 1200;
const int PLACEHEIGHT_PRACTICE = 1900;
const int PLACEHEIGHTPLATFORM_PRACTICE = 2675;
...
const int GRABHEIGHTPLATFORM_COMPETITION = 0; //Need to find value
